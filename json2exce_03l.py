...
if __name__ == '__main__':
    # call out and call in , the field of time sorted
    order_list_manual = ['callStartTime', 'callAnswerTime', 'callEndTime','userCallDuration', 'Ring', 'RingTime', 'Begin', 'End',
                         'AgentRing',
                         'AgentRingEnd', 'AgentHangup',
                         'InboundIVREndTime', 'QueueTime', 'QueueEndTime']
    # bot call, the field of time sorted
    order_list_bot = ['btime', 'altime', 'antime', 'botResponseTime', 'etime', 'createTime', 'duration', 'hangupdir']

    # writeM('41bot', alist=order_list_bot)
    file_list = get_files_of_dir('27日呼入转技能组')

    for file in file_list:
        writeM(file,alist=order_list_manual)
